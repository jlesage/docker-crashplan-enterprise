...
ARG CRASHPLAN_VERSION=10.4.0
ARG CRASHPLAN_TIMESTAMP=15252000061040
ARG CRASHPLAN_BUILD=224

# Define software download URLs.
ARG CRASHPLAN_URL=https://download.code42.com/installs/agent/cloud/${CRASHPLAN_VERSION}/${CRASHPLAN_BUILD}/install/Code42_${CRASHPLAN_VERSION}_${CRASHPLAN_TIMESTAMP}_${CRASHPLAN_BUILD}_Linux.tgz
...
# Pull base image.
FROM jlesage/baseimage-gui:alpine-3.16-v4.1.2
