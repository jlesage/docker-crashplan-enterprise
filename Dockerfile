...
ARG CRASHPLAN_VERSION=11.9.0
ARG CRASHPLAN_BUILD=507
...
# Install CrashPlan.
# NOTE: Make sure to do this after installing/removing packages that can affect
#       the installed rootfs of CrashPlan.
